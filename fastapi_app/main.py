...
app = FastAPI(
    ...
    description="Blogging system API built with FastAPI, SQLite, SQLAlchemy ORM, JWT authentication, subscription-based access control, email notifications, and user dashboard.",
    version="3.0.0",
    docs_url="/docs",
    redoc_url=None,
)
